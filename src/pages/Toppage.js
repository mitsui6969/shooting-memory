...
const Toppage = () => {
  ...
  return (
    <div className="toppage">
      ...
      {/* 使い方を表示 */}
      <button　className="button-common rule"onClick={() => setShowUsage(true)} /* 「使い方」ボタンを押した時に表示 */>使い方</button>

      {/* showUsageがtrueの時にだけ表示する */}
      {showUsage && (
        <div className="usage-box">
          <button className="button-common close" onClick={() => setShowUsage(false)}>×</button>
          <p>使い方</p>
        </div>
      )}
    </div>
